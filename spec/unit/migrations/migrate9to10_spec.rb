...
describe Migrate9To10 do
  ...
  it "adds the attribute patterns_system and sets it to zypper for systems without package system attribute" do
    migration = Migrate9To10.new(description_hash_without_package_system, description_base)
    migration.migrate

    expect(description_hash_without_package_system["patterns"]["_attributes"]["patterns_system"]).to eq("zypper")
  end
end
